            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mb-6">
                ...
                <form action="{{ route('admin.task-submissions.history') }}" method="GET" id="filterForm" class="space-y-4">
                    ...
                    <div class="flex justify-end mt-4">
                        <a href="{{ route('admin.task-submissions.history', ['type' => $type]) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition-colors">
                            <i class="fas fa-times"></i>
                            Clear Filters
                        </a>
                    </div>
