<x-admin-layout>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="card-surface">
                <div class="p-6 lg:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="rounded-2xl border border-gray-100 bg-gray-50 dark:bg-gray-700/40 p-6 mb-6 shadow-sm">
                    ...
                    <!-- Moderation Form -->
                    @php
                        $isFinalized = $incidentReport->isResolved() || $incidentReport->isDismissed();
                    @endphp
                    <form method="POST" action="{{ route('admin.incident-reports.update', $incidentReport) }}" novalidate>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" class="mt-1 block w-full rounded-xl border-gray-200 focus:border-brand-teal focus:ring-brand-teal sm:text-sm @if($isFinalized) opacity-70 cursor-not-allowed bg-gray-50 @endif" @if($isFinalized) disabled @endif required>
                            ...
                            <div>
                                ...
                                <select id="action_taken" name="action_taken" class="mt-1 block w-full rounded-xl border-gray-200 focus:border-brand-teal focus:ring-brand-teal sm:text-sm @if($isFinalized) opacity-70 cursor-not-allowed bg-gray-50 @endif" @if($isFinalized) disabled @endif>
                        ...
                        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-end">
                            ...
                            <button type="submit" 
                                    class="btn-brand @if($isFinalized) opacity-60 cursor-not-allowed @endif"
    ...
    <script>
        ...
        // Evidence modal (match task submissions UX)
