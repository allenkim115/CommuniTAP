        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="mt-3 flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                    <span><strong>Points:</strong> {{ $feedback->task->points_awarded }}</span>
                    <span><strong>Type:</strong> {{ ucfirst(str_replace('_', ' ', $feedback->task->task_type)) }}</span>
                    <span><strong>Status:</strong> {{ ucfirst($feedback->task->status) }}</span>
                </div>
            </div>
