            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="relative">
                            ...
                            @if($user->status === 'active')
                                <div class="absolute bottom-0 right-0 w-6 h-6 bg-green-500 rounded-full border-4 border-white shadow-sm"></div>
                            @elseif($user->status === 'suspended')
                                <div class="absolute bottom-0 right-0 w-6 h-6 bg-red-500 rounded-full border-4 border-white shadow-sm"></div>
                            @else
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3 flex-wrap">
                                ...
                                @elseif($user->status === 'suspended')
                                    <span class="inline-flex items-center gap-2 px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-semibold">
                ...
                <div class="p-6 lg:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200 hover:shadow-md transition-shadow">
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 rounded-lg bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-sm">
                                    <i class="fas fa-check-circle text-white text-lg"></i>
                                </div>
                                <div class="flex-1">
                                    <p class="text-sm font-medium text-gray-600 mb-1">Tasks Completed</p>
                                    <p class="text-2xl font-bold text-green-700">{{ number_format($tasksCompleted ?? 0) }}</p>
                                </div>
                            </div>
                        </div>
