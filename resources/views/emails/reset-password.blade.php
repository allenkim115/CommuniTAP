...
<head>
    ...
    <title>Reset Your Password - CommuniTap</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="message">
                We have received a request to reset the password for your <strong style="color: #F3A261;">CommuniTAP</strong> account. If you initiated this request, please proceed by clicking the button below to reset your password.
            </div>

            <div class="button-container">
                <a href="{{ $resetUrl }}" class="reset-button" style="color: #ffffff !important; text-decoration: none !important;">Reset Password</a>
            </div>

            <div class="warning">
                <p class="warning-text">
                    <strong>Please note: This password reset link will expire in {{ $count }} minutes for security purposes.</strong>
                </p>
            </div>

            <div class="footer-text">
                If you did not request a password reset, please disregard this email. Your account password will remain unchanged, and no action is required on your part.
            </div>
